...
- [x] [05 — compatibility and benchmark baseline](05.task_compatibility_benchmark_baseline.md)
- [x] [06 — threat and failure model](06.task_threat_failure_model.md)

## Exit gate

- [x] Binary starts and stops cleanly.
- [x] CI runs build, unit, lint, and race jobs.
- [x] Product promise and non-goals are approved.
- [x] Benchmark and failure fixtures are reproducible.
